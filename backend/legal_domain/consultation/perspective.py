...
ROLE_PATTERNS = {
    # Round-44: "我欠他3万元" / "我欠他5万" left the role unconfirmed because the
    # debtor pattern required the clause to end in "钱". 元/块/万 are amounts too.
    'debtor': ('借款人／被请求还款一方', r'(?:我是|本人是|我作为)(?:借款人|债务人)|我(?:向|找)[^，。；]{1,12}借了|我欠[^，。；]{0,12}(?:钱|元|块|万)'),
    # Round-46: "对方给我写了欠条" is a creditor signal; the negative lookbehind
    # keeps "给他写了欠条" (the user is the writer → debtor) out.
    'creditor': ('出借人／请求还款一方', r'(?:我是|本人是|我作为)(?:出借人|债权人)|我借给|欠我|向我借|借了我'
                 r'|(?<!给)(?:对方|他|她|商家|公司)(?:给我|向我)?(?:写|打|出具|出)了?(?:欠条|借条|借据)'),
